...
public final class SmartHotelRoomLightGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.example.smarthotelRoomLight.LightRequest,
      grpc.example.smarthotelRoomLight.LightResponse> getTurnonLightsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TurnonLights",
      requestType = grpc.example.smarthotelRoomLight.LightRequest.class,
      responseType = grpc.example.smarthotelRoomLight.LightResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.example.smarthotelRoomLight.LightRequest,
      grpc.example.smarthotelRoomLight.LightResponse> getTurnonLightsMethod() {
    io.grpc.MethodDescriptor<grpc.example.smarthotelRoomLight.LightRequest, grpc.example.smarthotelRoomLight.LightResponse> getTurnonLightsMethod;
      ...
      synchronized (SmartHotelRoomLightGrpc.class) {
        if ((getTurnonLightsMethod = SmartHotelRoomLightGrpc.getTurnonLightsMethod) == null) {
          SmartHotelRoomLightGrpc.getTurnonLightsMethod = getTurnonLightsMethod = 
              io.grpc.MethodDescriptor.<grpc.example.smarthotelRoomLight.LightRequest, grpc.example.smarthotelRoomLight.LightResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SmartHotelRoom.SmartHotelRoomLight", "TurnonLights"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.example.smarthotelRoomLight.LightRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.example.smarthotelRoomLight.LightResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.example.smarthotelRoomLight.LightRequest,
      grpc.example.smarthotelRoomLight.LightResponse> getTurnoffLightsMethod;
  ...
  public static io.grpc.MethodDescriptor<grpc.example.smarthotelRoomLight.LightRequest,
      grpc.example.smarthotelRoomLight.LightResponse> getTurnoffLightsMethod() {
    io.grpc.MethodDescriptor<grpc.example.smarthotelRoomLight.LightRequest, grpc.example.smarthotelRoomLight.LightResponse> getTurnoffLightsMethod;
  ...
  public static abstract class SmartHotelRoomLightImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void turnonLights(grpc.example.smarthotelRoomLight.LightRequest request,
        io.grpc.stub.StreamObserver<grpc.example.smarthotelRoomLight.LightResponse> responseObserver) {
     ...
     * </pre>
     */
    public void turnoffLights(grpc.example.smarthotelRoomLight.LightRequest request,
        io.grpc.stub.StreamObserver<grpc.example.smarthotelRoomLight.LightResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.example.smarthotelRoomLight.LightRequest,
                grpc.example.smarthotelRoomLight.LightResponse>(
  ...
  public static final class SmartHotelRoomLightBlockingStub extends io.grpc.stub.AbstractStub<SmartHotelRoomLightBlockingStub> {
     ...
     * </pre>
     */
    public grpc.example.smarthotelRoomLight.LightResponse turnonLights(grpc.example.smarthotelRoomLight.LightRequest request) {
     ...
     * </pre>
     */
    public grpc.example.smarthotelRoomLight.LightResponse turnoffLights(grpc.example.smarthotelRoomLight.LightRequest request) {
      return blockingUnaryCall(
  ...
  public static final class SmartHotelRoomLightFutureStub extends io.grpc.stub.AbstractStub<SmartHotelRoomLightFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.example.smarthotelRoomLight.LightResponse> turnonLights(
        grpc.example.smarthotelRoomLight.LightRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.example.smarthotelRoomLight.LightResponse> turnoffLights(
        grpc.example.smarthotelRoomLight.LightRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TURNON_LIGHTS:
          serviceImpl.turnonLights((grpc.example.smarthotelRoomLight.LightRequest) request,
              (io.grpc.stub.StreamObserver<grpc.example.smarthotelRoomLight.LightResponse>) responseObserver);
          break;
        case METHODID_TURNOFF_LIGHTS:
          serviceImpl.turnoffLights((grpc.example.smarthotelRoomLight.LightRequest) request,
              (io.grpc.stub.StreamObserver<grpc.example.smarthotelRoomLight.LightResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmartHotelRoomLightBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.example.smarthotelRoomLight.SmartHotelRoomLightProto.getDescriptor();
    }
